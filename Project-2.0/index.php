...
// $con = mysqli_connect('localhost', 'database_user', 'database_password','database_name');
 $con = mysqli_connect("localhost", "phpmyadmin", "redhat","phpmyadmin") or die("connection failed");
 ...
 <section id="services-container">
        ...
        <div id="services">
            ...
            <div class="box">
                ...
                <p class="center">We also cater to larger gatherings and parties with a highly skilled service staff. And no compromise on the quality Bulk >
            ...
            <div class="box">
                ...
                <p class="center">You Can now avail our services at the touch of a button,sitting at home. We accept online orders through swiggy,zomato wit>
    ...
    <section id="contact">
        ...
        <div id="contact-box">
            <form action="submit.php" method="post">
                ...
                <input type="phone" name="contactno" id="contactno" placeholder="Enter your contact number" required>
...
-->
    ...
    <ul class="icons">
        <li><a href="https://www.facebook.com/s.sabharwal.aniket" target="_blank"><ion-icon name="logo-facebook"></ion-icon></a></li>
        <li><a href="https://www.linkedin.com/in/aniket-sabharwal-545359213" target="_blank"><ion-icon name="logo-linkedin"></ion-icon></a></li>
        <li><a href="https://www.instagram.com/aniketsabharwal_/" target="_blank"><ion-icon name="logo-instagram"></ion-icon></a></li>
    </ul>
    <ul class="menu">
    ...
    <p>©2022 Aniket Sabharwal | All rights reserved</p>
</footer>
